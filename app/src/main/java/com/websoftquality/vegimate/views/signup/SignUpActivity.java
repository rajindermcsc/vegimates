...
import static com.websoftquality.vegimate.configs.Constants.ACTIVITY_REQUEST_CODE_START_FACEBOOK_ACCOUNT_KIT;
import static com.websoftquality.vegimate.utils.Enums.BIRTHDAY;
import static com.websoftquality.vegimate.utils.Enums.EMAIL;
import static com.websoftquality.vegimate.utils.Enums.FIRST_NAME;
import static com.websoftquality.vegimate.utils.Enums.GENDER;
import static com.websoftquality.vegimate.utils.Enums.LAST_NAME;
import static com.websoftquality.vegimate.utils.Enums.PASSWORD;
import static com.websoftquality.vegimate.utils.Enums.PROFILE_PICK;
import static com.websoftquality.vegimate.utils.Enums.VEGAN;
...
public class SignUpActivity extends AppCompatActivity implements SignUpActivityListener, ServiceListener {
    ...
    public void changeFragment(@Enums.Frag final String currentFrag, Bundle bundle, boolean isReplaceAll) {
        ...
        Log.e("TAG", "changeFragment: "+currentFrag);
        switch (currentFrag) {
            case VEGAN:
                VeganFragment veganFragment = new VeganFragment();
                veganFragment.setArguments(bundle);
                addBackStack(isReplaceAll, ft, VEGAN, veganFragment);
                break;
