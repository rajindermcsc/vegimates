...
public class CustomSeekBar extends View {
    ...
    public CustomSeekBar setLeftThumbHighlightColor(int leftThumbColorPressed) {
        this.leftThumbColorPressed = leftThumbColorPressed;
        return this;
    }

    public CustomSeekBar setLeftThumbDrawable(int resId) {
    ...
    public CustomSeekBar setLeftThumbDrawable(Drawable drawable) {
    ...
    public CustomSeekBar setLeftThumbBitmap(Bitmap bitmap) {
        leftThumb = bitmap;
        return this;
    }

    public CustomSeekBar setLeftThumbHighlightDrawable(int resId) {
        setLeftThumbHighlightDrawable(ContextCompat.getDrawable(getContext(), resId));
        return this;
    }

    public CustomSeekBar setLeftThumbHighlightDrawable(Drawable drawable) {
        setLeftThumbHighlightBitmap(getBitmap(drawable));
        return this;
    }

    public CustomSeekBar setLeftThumbHighlightBitmap(Bitmap bitmap) {
    ...
    public CustomSeekBar setLeftThumbColor(int leftThumbColorNormal) {
    ...
    protected final int getPosition(final TypedArray typedArray) {
        final int pos = typedArray.getInt(R.styleable.RangeSeekBar_position, Position.LEFT);
