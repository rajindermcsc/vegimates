package com.websoftquality.vegimate.views.customize;
/**
 * @package com.websoftquality.vegimate
 * @subpackage view.customize
 * @category CustomDialogList
...
/*****************************************************************
 Custom dialog box list fragment
 ****************************************************************/
@SuppressLint("ValidFragment")
public class CustomDialogList extends BaseDialogFragment {
    ...
    public CustomDialogList(String message, String confirmTxt, btnAllowClick okClickListener) {
    ...
    public CustomDialogList(boolean isProgressDialog) {
    ...
    public CustomDialogList(String message, String positiveBtnTxt, String negativeBtnTxt, btnAllowClick allowClickListener, btnDenyClick denyClickListener) {
        this.message = message;
        this.confirmTxt = "";
    ...
    public CustomDialogList(String title, String message, String confirmTxt, btnAllowClick okClickListener) {
        this.title = title;
        this.message = message;
        this.confirmTxt = confirmTxt;
        this.allowClickListener = okClickListener;
    ...
    public CustomDialogList(String title, String message, String positiveBtnTxt, String negativeBtnTxt, btnAllowClick allowClickListener, btnDenyClick denyClickListener) {
        this.title = title;
        this.message = message;
        this.confirmTxt = "";
        this.positiveBtnTxt = positiveBtnTxt;
        ...
        this.index = -1;
        setAnimation(false);
        setLayoutId(R.layout.activity_custombox_dialog);
        // tvAllow.setTextColor(ContextCompat.getColor(mActivity, R.color.color_accent));


    }

    public CustomDialogList(int index, String title, String message, String positiveBtnTxt, String negativeBtnTxt, btnAllowClick allowClickListener, btnDenyClick denyClickListener) {
        this.title = title;
        this.message = message;
        this.confirmTxt = "";
        this.positiveBtnTxt = positiveBtnTxt;
    ...
    public void initViews(View v) {
        ...
        if (isProgressDialog) {
            ...
            if (!TextUtils.isEmpty(title)) {
                ...
                tvMessage.setTextColor(ContextCompat.getColor(mActivity, R.color.text_light_gray));
            }
