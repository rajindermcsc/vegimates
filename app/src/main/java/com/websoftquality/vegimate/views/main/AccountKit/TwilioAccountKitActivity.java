package com.websoftquality.vegimate.views.main.AccountKit;
...
import com.websoftquality.vegimate.datamodels.main.LoginModel;
import com.websoftquality.vegimate.datamodels.main.NumberValidationModel;
...
import static com.websoftquality.vegimate.configs.Constants.FACEBOOK_ACCOUNT_KIT_PHONE_NUMBER_COUNTRY_CODE_KEY;
import static com.websoftquality.vegimate.configs.Constants.FACEBOOK_ACCOUNT_KIT_PHONE_NUMBER_KEY;
import static com.websoftquality.vegimate.utils.Enums.REQ_SEND_OTP;
import static com.websoftquality.vegimate.utils.Enums.REQ_VERIFY_NUMBER;
...
public class TwilioAccountKitActivity extends AppCompatActivity implements ServiceListener, View.OnClickListener {
    ...
    public void showPhoneNumberField() {
        cvNext.setCardBackgroundColor(getResources().getColor(R.color.color_accent));
