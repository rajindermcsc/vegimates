...
public class CustomDialogBox extends BaseDialogFragment {
    ...
    public CustomDialogBox(String message, String confirmTxt, btnAllowClick okClickListener) {
    ...
    public CustomDialogBox(boolean isProgressDialog) {
    ...
    public CustomDialogBox(String message, String positiveBtnTxt, String negativeBtnTxt, btnAllowClick allowClickListener, btnDenyClick denyClickListener) {
        this.message = message;
        this.confirmTxt = "";
    ...
    public CustomDialogBox(String title, String message, String confirmTxt, btnAllowClick okClickListener) {
        this.title = title;
        this.message = message;
        this.confirmTxt = confirmTxt;
        this.allowClickListener = okClickListener;
    ...
    public CustomDialogBox(String title, String message, String positiveBtnTxt, String negativeBtnTxt, btnAllowClick allowClickListener, btnDenyClick denyClickListener) {
        this.title = title;
        this.message = message;
        this.confirmTxt = "";
        this.positiveBtnTxt = positiveBtnTxt;
    ...
    public CustomDialogBox(int index, String title, String message, String positiveBtnTxt, String negativeBtnTxt, btnAllowClick allowClickListener, btnDenyClick denyClickListener) {
        this.title = title;
        this.message = message;
        this.confirmTxt = "";
        this.positiveBtnTxt = positiveBtnTxt;
