package com.websoftquality.vegimate.swipedeck;
/**
...
import com.websoftquality.vegimate.swipedeck.Utility.Deck;
import com.websoftquality.vegimate.swipedeck.Utility.SwipeCallback;
...
public class SwipeDeck extends FrameLayout {
    ...
    public void swipeTopCardLeft(int duration) {
        if (deck.size() > 0) {
            ...
            if (callback != null) {
                ...
                container.setClickRightImageResource(rightImageResource);
    ...
    public void swipeTopCardRight(int duration) {
        if (deck.size() > 0) {
            ...
            if (callback != null) {
                CardContainer container = deck.get(0);
                container.setClickLeftImageResource(leftImageResource);
