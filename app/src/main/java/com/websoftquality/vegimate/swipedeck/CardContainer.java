...
public class CardContainer {
    ...
    private com.websoftquality.vegimate.swipedeck.SwipeDeck parent;
    private long id;
    private int swipeDuration = com.websoftquality.vegimate.swipedeck.SwipeDeck.ANIMATION_DURATION;
