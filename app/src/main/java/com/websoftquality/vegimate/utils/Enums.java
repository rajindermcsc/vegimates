...
public class Enums {
    public static final String MY_PHONE_NUMBER = "com.websoftquality.vegimate.views.signup.PhoneNumberFragment";
    public static final String ONE_TIME_PWD = "com.websoftquality.vegimate.views.signup.OneTimePwdFragment";
    public static final String GENDER = "com.websoftquality.vegimate.views.signup.GenderFragment";
    public static final String VEGAN = "com.websoftquality.vegimate.views.signup.VeganFragment";
    public static final String FIRST_NAME = "com.websoftquality.vegimate.views.signup.FirstNameFragment";
    public static final String LAST_NAME = "com.websoftquality.vegimate.views.signup.LastNameFragment";
    public static final String PASSWORD = "com.websoftquality.vegimate.views.signup.PasswordFragment";
    public static final String BIRTHDAY = "com.websoftquality.vegimate.views.signup.BirthdayFragment";
    public static final String EMAIL = "com.websoftquality.vegimate.views.signup.EmailFragment";
    public static final String PROFILE_PICK = "com.websoftquality.vegimate.views.signup.ProfilePickFragment";
    ...
    @StringDef({MY_PHONE_NUMBER, ONE_TIME_PWD, GENDER,VEGAN ,FIRST_NAME, LAST_NAME, PASSWORD, EMAIL, BIRTHDAY, PROFILE_PICK})
